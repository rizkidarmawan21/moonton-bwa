                ...
                <div class="flex justify-center gap-10 mt-[70px]">
                    ...
                    <div class="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-black w-[300px] h-[max-content]">
                        ...
                        <div>
                            ...
                            <div class="text-[28px] font-bold">IDR 299.000</div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <img src="assets/icons/ic_tick.svg" alt="" />
                                <span class="text-sm">Up to 3 users</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <img src="assets/icons/ic_tick.svg" alt="" />
                                <span class="text-sm">Support 24/7 ready</span>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-[30px] py-[30px] px-7 outline outline-1 outline-[#F1F1F1] rounded-[26px] text-white w-[300px] bg-black">
                        ...
                        <div>
                            ...
                            <div class="text-[28px] font-bold">IDR 800.000</div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm">iOS, Android, TV</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg
                                    width="24"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm">Up to 20 users</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg
                                    width="24"
